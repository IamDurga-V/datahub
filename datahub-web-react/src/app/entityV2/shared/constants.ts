...
export const REDESIGN_COLORS = {
    ...
    HIGHLIGHT_PURPLE: '#2E2B4A',
    LINK_HOVER_BLUE: '#5280E2',
    RED_ERROR_BORDER: '#FFA39E',
    BACKGROUND_SECONDARY_GRAY: '#2E2E3A',
    BACKGROUND_GRAY_2: '#1E1E2F',
    BACKGROUND_GRAY_3: '#171723',
    BACKGROUND_GRAY_4: '#1F1F2B',
    ...
    SIDE_BAR_BORDER_RIGHT: '#2D2D3A',
    DARK_PURPLE: '#6C6B88',
    LINK_GREY: '#586287',
    TEXT_GREY: '#8D95B1',
    WARNING_RED: '#d07b7b',
    SUBTITLE: '#A9ADBD',
    LIGHT_GREY_BORDER: '#2D2D3A',
